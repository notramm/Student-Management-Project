            ...
            <form action="{{ url('enrollments/' . $enrollments->id) }}" method="post">
                ...
                <select name="batch_id" id="batch_id" class="form-control">
                    ...
                    @foreach ($batches as $id => $name)
                        <option value="{{ $id }}" @if ($id == $enrollments->batch_id) selected='selected' @endif>
                            {{ $name }}</option>
                    @endforeach
                </select></br>
                ...
                <select name="student_id" id="student_id" class="form-control">
                    ...
                    @foreach ($students as $id => $name)
                        <option value="{{ $id }}" @if ($id == $enrollments->student_id) selected='selected' @endif>
                            {{ $name }}</option>
                    @endforeach
                </select></br>
                <label>Join Date</label></br>
                <input type="text" name="join_date" id="join_date" value="{{ $enrollments->join_date }}"
                    class="form-control"></br>
                <label>Fee</label></br>
                <input type="text" name="fee" id="fee" value="{{ $enrollments->fee }}"
                    class="form-control"></br>
